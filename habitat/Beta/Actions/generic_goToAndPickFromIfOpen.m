...
;	 of-it-if-it's-open operation.
;	This is the 'get' behavior for non-portable containers.
;
...
;	 picking from a sub-menu.  If the object is CLOSED, we fail.
;
